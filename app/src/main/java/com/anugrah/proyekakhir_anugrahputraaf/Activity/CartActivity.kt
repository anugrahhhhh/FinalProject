package com.anugrah.proyekakhir_anugrahputraaf.Activity
...
import com.anugrah.proyekakhir_anugrahputraaf.R
...
@Composable
fun CartSumarry(itemTotal: Double, tax: Double,dilivery: Double) {
    val total = itemTotal + tax + dilivery
...
fun CartItem(
    ...
    item:ItemsModel, managementCart: ManagmentCart,
    onItemChange: () -> Unit
) {
    ConstraintLayout(
        modifier = Modifier
